...
|----------|------|---------|
| 01 | Arquitectura en capas | [Ver →](./manual-linq-PA/manual-linq/01-arquitectura-capas/README.md) |
| 02 | Capa de Entidades | [Ver →](./manual-linq-PA/manual-linq/02-entidades/README.md) |
| 03 | Capa de Datos con ADO.NET | [Ver →](./manual-linq-PA/manual-linq/03-capa-datos-sql/README.md) |
| 04 | Capa de Datos con LINQ to SQL | [Ver →](./manual-linq-PA/manual-linq/04-capa-datos-linq/README.md) |
| 05 | Capa de Datos con Entity Framework | [Ver →](./manual-linq-PA/manual-linq/05-capa-datos-ef/README.md) |
| 06 | Lógica de Negocio | [Ver →](./manual-linq-PA/manual-linq/06-logica-negocio/README.md) |
| 07 | Capa de Presentación | [Ver →](./manual-linq-PA/manual-linq/07-presentacion/README.md) |
| 08 | Consultas LINQ Avanzadas | [Ver →](./manual-linq-PA/manual-linq/08-linq-consultas-avanzadas/README.md) |
| 09 | Comparativa: ADO.NET vs LINQ vs EF | [Ver →](./manual-linq-PA/manual-linq/09-comparativa-tecnologias/README.md) |
| 10 | Errores Comunes y Soluciones | [Ver →](./manual-linq-PA/manual-linq/10-errores-comunes/README.md) |
| 11 | Ejercicios Resueltos | [Ver →](./manual-linq-PA/manual-linq/11-ejercicios-resueltos/README.md) |
| 12 | Git Workflow para el Proyecto | [Ver →](./manual-linq-PA/manual-linq/12-git-workflow/README.md) |
